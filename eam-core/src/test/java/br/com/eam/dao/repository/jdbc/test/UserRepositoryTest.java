...
public class UserRepositoryTest {
	...
	public void testUser() {
		...
		Assert.assertEquals(result.getUserBirthday().getTime(), user.getUserBirthday().getTime());
	...
	public void testUserWithPerson() {
		...
		Assert.assertEquals(result.getPerson().getId(), user.getPerson().getId());
		
		Assert.assertEquals(result.getPerson().getBloodStatus(), user.getPerson().getBloodStatus());
		Assert.assertEquals(result.getPerson().getForename(), user.getPerson().getForename());
		Assert.assertEquals(result.getPerson().getGender(), user.getPerson().getGender());
		Assert.assertEquals(result.getPerson().getMaritalStatus(), user.getPerson().getMaritalStatus());
		Assert.assertEquals(result.getPerson().getMiddleNames(), user.getPerson().getMiddleNames());
		Assert.assertEquals(result.getPerson().getSpecies(), user.getPerson().getSpecies());
		Assert.assertEquals(result.getPerson().getStory(), user.getPerson().getStory());
		Assert.assertEquals(result.getPerson().getSurname(), user.getPerson().getSurname());
		Assert.assertEquals(result.getPerson().getUsername(), user.getPerson().getUsername());
		Assert.assertEquals(result.getPerson().getDeathDate().getTime(), user.getPerson().getDeathDate().getTime());
		Assert.assertEquals(result.getPerson().getBirthday().getTime(), user.getPerson().getBirthday().getTime());
	}
	...
	public void testUpdateWithChanges() {
		...
		Assert.assertEquals(result.getUserBirthday().getTime(), update.getUserBirthday().getTime());
	}
